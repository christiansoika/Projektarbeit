...
\begin{figure}[h]
    ...
    \begin{minipage}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{./Simulationsergebnisse/variationWolken/128/der(kineticEnergy)_time.pdf}
        \caption{Example Caption 1}
        \label{der(kineticEnergy)_time_128}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{./Simulationsergebnisse/variationWolken/128/coupling_time.pdf}
