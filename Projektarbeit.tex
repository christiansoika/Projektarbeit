...
Sollen wir hier außerdem noch ein Bild von einer turbulenten Strömung einfügen?
\pagebreak
...
\end{table}
\newline
See table \ref{table1} on page \pageref{table1} for the example table.
boundary conditions, for example Reynolds number?
\begin{figure}[h]
	\centering
  \includegraphics[]{./Simulationsergebnisse/variationPartikelAnzahl/128/kineticEnergy_numberOfParticles.pdf}
...
\begin{figure}[h]
	\centering
  \includegraphics[]{./Simulationsergebnisse/variationWolken/128/coupling_time.pdf}
	\caption{Include Caption}
...
\begin{figure}[h]
	\centering
  \includegraphics[]{./Simulationsergebnisse/variationWolken/128/der(kineticEnergy)_time.pdf}
	\caption{Include Caption}
...
\begin{figure}[h]
	\centering
  \includegraphics[]{./Simulationsergebnisse/variationWolken/128/kineticEnergy_time.pdf}
	\caption{Include Caption}
