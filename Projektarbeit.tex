...
\begin{figure}[]
	\centering
  \includegraphics[width=0.5\textwidth]{./Simulationsergebnisse/variationWolken/128/coupling_time.pdf}
	\caption{Include Caption}
...
\begin{figure}[]
	\centering
  \includegraphics[width=0.5\textwidth]{./Simulationsergebnisse/variationWolken/128/der(kineticEnergy)_time.pdf}
	\caption{Include Caption}
