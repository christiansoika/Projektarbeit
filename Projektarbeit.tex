...
boundary conditions, for example Reynolds number?
 ...
 \includepdf[pages={1}]{./Stephen B. Pope-Turbulent Flows} %Dateiname einfuegen um Datei zu verwenden
 
\begin{figure}
 \centering %setzt das Bild mittig
 \includepdf[]{./Stephen B. Pope-Turbulent Flows.pdf} %Dateiname einfuegen um Datei zu verwenden
 \caption{Gaps in kinetic energy between different number of particles} %setzt die Bildunterschrift
 \label{Gaps_64} %setzt das Label
\end{figure}
