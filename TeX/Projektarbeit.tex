...
\nomenclature[re]{$\vec{e}$}{unit vector in the same direction as $\vec{u}'$}
...
\nomenclature[gOp]{$\vec{\omega}_\mathrm{p})$}{vorticity vector of the undisturbed flow around one particle}
...
\nomenclature[rN]{$N$}{number of numerical operations}
...
\nomenclature[rmv]{$m_\mathrm{v}$}{mass of one cell}
