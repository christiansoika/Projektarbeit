...
\newline
The properties of these simulations can be found in table \ref{table_properties} on page \pageref{table_properties}. The ratio of the densities was set to $\frac{\rho_\mathrm{p}}{\rho} = 1000$. At the timestep of injection the particle response time $\tau_\mathrm{p}=\frac{d^2}{18 \nu} \frac{\rho_\mathrm{p}}{\rho}$ was 0.03497 \textbf{Uebepruefen, ist die Viskositaet die richtige?}.
\begin{table}[h]
\begin{tabular}{l | c c c c c c c }
$m_\mathrm{c}$ & $u_0$ & $\epsilon$ & $\lambda$ & $\eta $ & $Re_\lambda$ \\
\hline
\hline
1 & 0.7628 & 5.22897 & 0.0317221 & 0.00207819 & 60.1557  \\
10 & 0.7628 & 5.22927 & 0.0317214 & 0.00207816 & 60.1547 \\
50 & 0.76282 & 5.23008 & 60.1512 & 0.0020780 & 60.1512   \\
100 & 0.76286 & 5.23117 & 0.0317167 & 0.00207797 & 60.148  \\
1000 & 0.76301 & 5.2359 & 0.0317056 & 0.00207751 & 60.1329   \\
\hline
\end{tabular}
\caption{Variables of the first set of simulations at the time of injection for $128^3$-case}
