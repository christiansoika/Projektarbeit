...
\usepackage{geometry} %Grˆﬂe des Bodys innerhalb der Seite 
\usepackage[utf8]{inputenc} 
%bindet die benutzten Packages ein

\linespread{1.25} %grˆﬂerer Zeilenabstand
...
{ \huge \bfseries Investigations on two-way coupling effects of particle-laden decaying isotropic turbulent flows}\\[0.3cm] % Groﬂüe Buchstaben, fett gedruckt, lasse 0.3cm Platz nach unten
\HRule \\[0.5cm] %Linie, 0,5cm Platz nach unten
\textsc{\Large{Projektarbeit}}\\ %in Kapit√§lchen
\textsc{\Large{von}}\\
...
\vfill % So viel Platz lassen, dass es bis zur Ende der Seite geht, wobei die Abst√§nde bei dem n√§chsten vfill gleich sind
\begin{flushleft} \large  %Einr√ºckung, gro√ü
...
=======
This work deals with particle laden fluids, therefore the impact of them on the flow behavior of the fluid needs to be described. This phenomenon is called two-way-coupling and the exchanged energy per time between fluid and particles is called coupling rate. 
>>>>>>> 52af3cfbc70603477bc193c5c23d918d1899c883
\newline
