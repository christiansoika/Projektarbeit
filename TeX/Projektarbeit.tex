...
To provide a common basis of knowledge, the basic equations and scales of a flow are discussed, as well as particle-considering equations. %anderes Wort für discussed?
\newline
...
\newline
Characteristic length scales of a turbulent flow can be defined by the two-point-correlation $R$, which is the normalized product of the velocity's fluctuations $\vec{u'}$ at two different positions %Zitat Skript AIA Strömungs und Temperaturgrenzschichten muss noch hinzugefügt werde! 2017-10-25 JS
...
This chapter deals with the forces acting between particles and the carrier fluid, as well as their incorporation in the dynamic equations.
\newline
...
Reduced to the governing forces acting on the particles and under neglection of gravity the dynamic equation of the particles becomes
...
\end{equation}
\nomenclature[gpsi]{$\Psi_\mathrm{pp}$}{Coupling rate using the point-particle approach}
