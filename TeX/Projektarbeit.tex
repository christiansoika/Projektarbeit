...
\end{figure}
It can be seen in \ref{kineticEnergy_time_128} that the decay in kinetic energy from the starting point depends in a degree that is not negligible for most applications. With 10 particles per cluster, the solutions could be usable to get a first impression for technical purposes, all other simulations show a high variety. 
\newline
\begin{figure}[h]
    \centering
